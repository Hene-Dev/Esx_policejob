Locales['fi'] = {
  ...
  -- Action Menu
  ['citizen_interaction'] = 'Siviilin kanssakäynti',
  ['vehicle_interaction'] = 'Trafi',
  ...
  ['fine'] = 'sakko',
  ['unpaid_bills'] = 'Tarkista maksamattomat sakot',
  ...
  ['being_searched'] = '~r~Tunnet kun sinun taskuja tutkitaan',
  -- Vehicle interaction
  ...
  -- Notifications
  ['alert_police'] = 'Poliisi viesti',
  ['phone_police'] = 'poliisi',

 ['revive player'] = 'Koita elvyttää',
